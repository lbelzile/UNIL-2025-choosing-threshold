...
subtitle: "Séminaire de recherche du département des opérations, UNIL"
date: "2025-12-05"
...
::::
Research question: what is the expected maximum rainfall episode over a 100 year period?
...
## Expected value of 100-year maximum
...
There are earlier reviews of the topic, but the literature keeps growing...
...
load("/home/lbelzile/Documents/Dropbox/Publications/Ongoing/Threshold/Code/application/simulation_shapes.RData")
g_quant <- g_quant + ggplot2::scale_y_continuous(transform = "identity")
g_shape +
  (g_quant) +
...
- $A(t) =\xi_t - \xi,$ assuming $u_t$ is twice differentiable.
...
#| fig-align: 'center'
#| out-width: '90%'
knitr::include_graphics("figures/Fig-penultimate_normal.png")
```
...
## Graphical stability plots

```{r}
knitr::include_graphics("figures/padova_visualdiag.png-1.png")
```
...
- Problems: pointwise confidence intervals (except @Wadsworth:2016)
...
#| out-width: '70%'
#| fig-align: 'center'
knitr::include_graphics("figures/fig-retlev_EGP.png")
```
...
- @Choulakian.Stephens:2001, @Gonzalo.Olmo:2004,  @Bader.Yan.Zhang:2018 (using ForwardStop).
...
\begin{align*}
 \widehat{T}_v(u_j) = \sum_{r=1}^{n_u} \log\widehat{f}_v(x_r \mid \boldsymbol{x}_{-r}, u_j).
\end{align*}
...
20 threshold selection methods are implemented in `mev` (version 2.1). Many nonparametric methods in `tea`.
...
Slides: [`lbelzile.github.io/UNIL-2025-choosing-threshold`](https://lbelzile.github.io/UNIL-2025-choosing-threshold)
